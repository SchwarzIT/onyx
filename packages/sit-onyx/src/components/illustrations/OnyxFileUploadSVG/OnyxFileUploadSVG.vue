...
<template>
  <svg
    ...
    :class="{
      ...
      'onyx-file-upload-svg--error': props.error,
    }"
    width="50"
    height="64"
    viewBox="0 0 50 64"
  ...
  >
    ...
    />
    <g v-if="props.error" transform="translate(24, 37) scale(0.9)">
      <path
        fill-rule="evenodd"
        d="M4.5 9v10.5a.75.75 0 0 0 .75.75h7.5v1.5h-7.5A2.25 2.25 0 0 1 3 19.5V7.95l5.434-5.7H18V13.5h-1.5V3.75H9.75V9zm3.75-4.383L5.501 7.5H8.25z"
        clip-rule="evenodd"
        fill="var(--onyx-file-upload-svg-color-bubble)"
      />
      <path
        d="M15 11.25H6v1.5h9zm-4.5 3v1.5H6v-1.5zm9.97.97 1.06 1.06-2.47 2.47 2.47 2.47-1.06 1.06L18 19.81l-2.47 2.47-1.06-1.06 2.47-2.47-2.47-2.47 1.06-1.06L18 17.69z"
        fill="var(--onyx-file-upload-svg-color-bubble)"
      />
    </g>
    <path
