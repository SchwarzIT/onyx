...
> & {
  /**
   * The currently applied sorting. Will be updated by the data grid, can be used for reading,
   * updating and watching the applied sorting.
   */
  sortState?: MaybeRef<SortState<TEntry>>;
  /**
   * The `Intl.Collator` used for the default (string-based) sorting. The collator allows for
   * customizing the sorting behavior, see [MDN
   * Collator](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Intl/Collator/Collator).
   *
   * Defaults to `new Intl.Collator(i18n.locale.value, { numeric: true })` where `i18n` is the
   * OnyxI18n instance.
   */
