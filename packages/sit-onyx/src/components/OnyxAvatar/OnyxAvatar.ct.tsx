...
test("should show custom image", async ({ mount, makeAxeBuilder, page }) => {
  ...
  await expect(component).toHaveScreenshot("custom-image.png");
  ...
  await component.update({ props: { src: mockImageUrl } });
