...
export type OnyxFileUploadProps<TMultiple extends boolean> = DensityProp &
  ...
  Partial<Pick<OnyxFormElementV2Props, "label">> & {
     ...
     * docs](https://www.iana.org/assignments/media-types/media-types.xhtml).
     *
     * @see: https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Elements/input/file#unique_file_type_specifiers
     */
    accept?: FileType[];
    /**
     * Max. allowed file size per file. Can be a number in bytes (e.g. 1024 * 1024 * 42) or a
    ...
    /**
     * Max. allowed total file size for all files when `multiple` is enabled. Can be a number in
...
/**
 * Unique file type specifier. For a full list of media types, see the [official
 * docs](https://www.iana.org/assignments/media-types/media-types.xhtml).
 *
 * @see https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Elements/input/file#unique_file_type_specifiers
 */
