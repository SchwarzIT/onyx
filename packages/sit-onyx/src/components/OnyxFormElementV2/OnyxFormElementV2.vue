...
.onyx-form-element-v2 {
  @include layers.component() {
    ...
    --onyx-form-element-v2-border-color: var(--onyx-color-component-border-secondary);
    --onyx-form-element-v2-border-color-hover: var(--onyx-color-component-border-secondary-hover);
