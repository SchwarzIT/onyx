...
/**
 * Register page route handlers to register mocks for onyx logos that can be used as images during
 * Playwright tests. Use the `MOCK_PLAYWRIGHT_LOGO_URL` or `MOCK_PLAYWRIGHT_LOGO_WIDE_URL` constant
 * as image URL then.
 */
...
/**
 * Matrix screenshot hooks for illustrations screenshot tests which will apply light/dark theme
 * settings correctly.
 */
