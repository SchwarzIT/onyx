...
For the technical implementation of the headlines, please see the [technical documentation](/development/components/Headline).
...
For the technical implementation of the links, please see the [technical documentation](/development/components/Link).
