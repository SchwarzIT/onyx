...
import { iconFile, iconMail, iconTrash, iconUserGroup, iconUserId } from "@sit-onyx/icons";
...
const sidebarItems = computed<SidebarItem[]>(() => [
  ...
  { label: t("role", 2), icon: iconUserGroup },
  { label: t("document", 2), icon: iconFile },
]);
...
<template>
  <NuxtLayout name="sidebar" :sidebar-items footer-alignment="page">
