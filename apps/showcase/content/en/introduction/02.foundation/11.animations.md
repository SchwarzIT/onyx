...
Therefore, users can configure their browser to prefer reduced motion which is provided to the application. Developers should consider this user preference when implementing animations or transitions.
