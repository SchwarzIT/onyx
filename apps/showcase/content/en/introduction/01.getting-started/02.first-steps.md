...
- [Theming](/introduction/foundation/colors), e.g. for setting up the dark mode
- [i18n](/introduction/foundation/i18n) if you are supporting multiple languages in your application
- [Grid](/introduction/foundation/breakpoints-and-grid) for easily implementing custom layouts
