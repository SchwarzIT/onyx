...
import { createFeature, OnyxDataGrid, OnyxInfoTooltip, type ColumnConfig } from "sit-onyx";
...
const withCustomSlots = createFeature(() => ({
  ...
  slots: {
    headline: (slotContent) => {
      return [
        h("div", { class: "headline-wrapper" }, [
          // make sure to keep existing slot content from other features
          ...slotContent(),
          h(OnyxInfoTooltip, { text: "Example tooltip text" }),
        ]),
      ];
    },
  },
