...
When the user has a selection inside the row (e.g. marked text to copy), the click will be disabled by default. This behavior can optionally be disabled using the `ignoreSelection` option.
