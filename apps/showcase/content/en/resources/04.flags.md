---
title: Flags
description: onyx includes a set of well-crafted SVG flags that are free to use.
---
...
To get started, install the npm package with your corresponding package manager: code-group
